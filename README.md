...
**1. Risk is a Switch, Not a Spectrum**
I tried to calibrate the probabilities to get a nice smooth curve. The model refused. It polarised everything to 0% or 99%.
...
I stressed-tested the model by throwing in the chaotic 2021 (COVID) dataset.
...
* **The "Stable" Run (Post-2022):** Catches 60% of failures with half the workload. This is the champion model in the repo.
